...
//				'orderqty'	=> $updateorderqty
//			);
//			$this->M_neworder->orderqty_update($data2);
		}
...
//				$this->output
//					->set_content_type('application/json')
//					->set_output(json_encode(array('status' => 'success','message' => 'Order 1 insert successful')));
//			} 
//			elseif(!empty($customercode)){
//
//				$this->output
//					->set_content_type('application/json')
//					->set_output(json_encode(array('status' => 'success','message' => 'Order 2 insert successful')));
//			} 
//			else{
//				$this->output
//					->set_content_type('application/json')
//					->set_output(json_encode(array('status' => 'error','message' => 'No order insert')));
//			}
//		}
	} // End of function
}
