		...
		<div class="row bg-title">
			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					...
					<li class="active">Convince Bills Records</li>
				</ol>
			</div>
			<!-- /.col-lg-12 -->
		</div>
				...
				<div class="white-box">
					<div class="padding-bottom-15">
						<div class="col-12 col-sm-12 col-md-6 col-lg-9 col-xl-9">
							<h3 class="box-title m-b-0">Convince Record</h3>
						...
						<div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 m-b-5">
							<a href="<?php echo base_url("covinceinsert"); ?>" class="btn btn-block btn-black"><i class="fa fa-plus-square p-r-10"></i> Add New Convince</a>
						</div>
					</div>
						...
						<table id="demo-foo-addrow" class="toggle-circle table-hover">
							<thead>
								<tr class="tabletrpad1">
									...
									<th class="tabletdpad tdr" data-hide="phone"> Date </th>
									<th class="tabletdpad tdr"> Amount </th>
									<th class="tabletdpad tdr"> Remark </th>
									<th class="tabletdpad tdr"> Invoice Image </th>
									<th class="tabletdpad tdr" data-hide="all"> Prepared By </th>
							...
							<?php
								if($convince_list > 0){
							 	foreach($convince_list as $row):
									//if($row->createdby == $metadata['id']){
							?>
								<tr class="tabletrpad">
									<td class="tabletdpad1">
										<?php echo $row->convincecode;?>
									</td>
									<td class="tabletdpad">
										<?php echo $row->prepared_at;?>
									</td>
									<td class="tabletdpad">
										<?php echo $row->amount;?>
									</td>
									...
									<td class="tabletdpad">
										<div class="el-card-item">
											<div class="el-card-avatar el-overlay-1"> <a class="image-popup-vertical-fit" href="<?php echo base_url("assets/admin/"); ?>upload-images/bills/convince-bills/<?php echo $row->invoiceimage; ?>"><img class="tableimagebill" src="<?php echo base_url("assets/admin/"); ?>upload-images/bills/convince-bills/<?php echo $row->invoiceimage; ?>"></a>
											</div>
										</div>
									</td>
									<td class="tabletdpad">
