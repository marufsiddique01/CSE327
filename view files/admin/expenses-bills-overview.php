	...
	<div id="wrapper">
		...
		<div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
					...
					<!--
                    <li> <a href="product-archive.php" class="waves-effect"><i class="fa fa-shopping-bag p-r-10"></i> <span class="hide-menu">All products</span></a> </li>-->
					...
					<li><a href="javascript:void(0);" class="waves-effect"><span style="color:red"> <i class="fa fa-dollar p-r-10"></i> <span class="hide-menu">Expenses/ Bills<span class="fa arrow"></span></span></span></a>
						<ul class="nav nav-second-level">
							<li> <a href="expenses-bills-personal-new.php">Personal Bills</a>
							</li>
							<li> <a href="expenses-bills-company-new.php">Company Expenses</a>
							</li>
							<li> <a href="javascript:void(0);">View Expenses<span class="fa arrow"></span></a>
					...
					<!--
                    <li> <a href="add-patient.php" class="waves-effect"><i class="fa fa-user p-r-10"></i> <span class="hide-menu">Add New Admin</span></a> </li>
                    
                    <li> <a href="edit-patient.php" class="waves-effect"><i class="icon-user-follow p-r-10"></i> <span class="hide-menu">Edit Member</span></a> </li>
-->
							...
							<div class="row m-b-10">
								<div class="col-lg-6 col-md-6 col-sm-3 col-xs-12">
									<div class="ribbon-wrapper">
										<div class="ribbon ribbon-bookmark ribbon-default">Personal Bills</div>
										<p class="ribbon-content">To view personal bills click the button.</p>
										<div class="col-lg-5 col-sm-4 col-xs-12">
											<button class="btn btn-block btn-outline btn-primary" onclick="window.location.href='expenses-bills-personal-view.php'">Personal Bills</button>
										</div>
									</div>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-3 col-xs-12">
									<div class="ribbon-wrapper-reverse">
										<div class="ribbon ribbon-bookmark ribbon-right ribbon-danger">Company Bills</div>
										<p class="ribbon-content">To view company bills click the button.</p>
										<div class="col-lg-5 col-sm-4 col-xs-12">
											<button class="btn btn-block btn-outline btn-primary" onclick="window.location.href='expenses-bills-company-view.php'">Company Bills</button>
										</div>
									</div>
								</div>
							</div>
