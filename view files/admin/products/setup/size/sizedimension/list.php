		...
		<div class="row bg-title">
			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					...
					<li class="active">Dimension List</li>
				</ol>
			</div>
			<!-- /.col-lg-12 -->
		</div>
				...
				<div class="white-box">
					<div class="padding-bottom-15">
						<div class="col-12 col-sm-12 col-md-6 col-lg-9 col-xl-9">
							<h3 class="box-title m-b-0">Item Dimension List</h3>
						...
						<div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 m-b-5">
							<a href="<?php echo base_url("dimensioninsert"); ?>" class="btn btn-block btn-black"><i class="fa fa-plus-square p-r-10"></i> Add New Dimension</a>
						</div>
					</div>
						...
						<table id="demo-foo-addrow" class="toggle-circle table-hover">
							<thead>
								<tr class="tabletrpad1">
									<th class="tabletdpad tdr" data-toggle="true" data-hide="phone"> Size </th>
									<th class="tabletdpad tdr" data-hide="phone"> Category </th>
									<th class="tabletdpad tdr" data-hide="phone"> Sub-Category </th>
									<th class="tabletdpad tdr"> Body Length </th>
									<th class="tabletdpad tdr"> Shoulder Width </th>
									<th class="tabletdpad tdr"> Body Width </th>
							...
							<tbody>
								...
								<tr class="tabletrpad">
									...
									<td class="tabletdpad">
										<?php echo $row->category_id_1;?>
									</td>
									<td class="tabletdpad">
										<?php echo $row->category_id_2;?>
									</td>
									<td class="tabletdpad">
										<?php echo $row->body_length;?>
									</td>
									<td class="tabletdpad">
										<?php echo $row->shoulder_width;?>
									</td>
									<td class="tabletdpad">
										<?php echo $row->body_width;?>
									</td>
									<td></td>
									<td></td>
									<td class="tabletdpad">
