				...
				<div class="white-box">
					<div class="padding-bottom-15">
						...
						<div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 m-b-5">
							<a href="<?php echo base_url("categoryinsert"); ?>" class="btn btn-block btn-black"><i class="fa fa-plus-square p-r-10"></i> Add New Category</a>
						</div>
					</div>
						...
						<table id="demo-foo-addrow" class="toggle-circle table-hover">
							<thead>
								<tr class="tabletrpad1">
									<th class="tabletdpad tdr" data-toggle="true"> Category </th>
									<th class="tabletdpad tdr"> Sub-Category </th>
