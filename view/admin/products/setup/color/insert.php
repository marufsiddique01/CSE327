		...
		<div class="row bg-title">
			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					...
					<li class="active">Color Upload</li>
				</ol>
			</div>
			<!-- /.col-lg-12 -->
		</div>
				...
				<div class="white-box">
					<div class=" m-b-20 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-12 col-sm-12 col-md-6 col-lg-9 col-xl-9">
							<h3 class="box-title m-b-0">New Color Upload</h3>
							<span><p class="text-muted m-b-0">Upload New Color Information:</p></span>
						</div>
						<div class="col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 m-b-5">
							<a href="<?php echo base_url("colorlist"); ?>" class="btn btn-block btn-black"><i class="fa fa-list p-r-10"></i> Color List</a>
						</div>
					</div>
					...
					<form id="validateForm" action="#" class="form-horizontal" method="POST" enctype="multipart/form-data" autocomplete="off">
						<div class="form-group">
							<div class="ipadform">
								<label class="control-label col-12 col-sm-12 col-md-2 col-lg-1 col-xl-1">Color Name:</label>
...
//	MAIN AJAX starts
	$( document ).on( 'click', '#submit', function () {
			...
			$.ajax( {
				url: "<?php echo base_url("coloruploaded"); ?>",	// Url to which the request is send
