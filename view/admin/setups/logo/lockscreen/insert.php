		...
		<div class="row bg-title">
			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					...
					<li>Setup</li>
					<li class="active">Lockscreen Upload</li>
				</ol>
			</div>
			<!-- /.col-lg-12 -->
		</div>
				...
				<div class="white-box">
					<div class=" m-b-20 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9">
							<h3 class="box-title m-b-0">New Lockscreen Upload</h3>
						</div>
						<div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
							<a href="<?php echo base_url("lockscreenlogolist"); ?>" class="btn btn-block btn-black"><i class="fa fa-list p-r-10"></i> Lockscreen Logo List</a>
						</div>
					</div>
					<form id="validateForm" action="#" class="form-horizontal" method="POST" enctype="multipart/form-data" autocomplete="off">
						<div class="form-group">
							<div class="ipadform">
								<label class="control-label col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1">Logo Name: </label>
								<div class="col-md-2">
									<input type="text" class="form-control col-12 col-sm-12 col-md-12 col-lg-2 col-xl-2" name="name" id="name">
								</div>
								
								<label class="control-label col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1">Upload logo:</label>
								<div class="col-12 col-sm-12 col-md-12 col-lg-5 col-xl-5">
									...
									<input type="file" name="lckimage" id="lckimage">
									</span>
						...
						<div class="form-group">
							...
							<div class="col-md-2 hidden">
								<input type="text" class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 hidden" name="createdby" id="createdby" value="<?php echo $metadata['id']?>" readonly>
							</div>
						</div>
...
//	MAIN AJAX starts
	$( document ).on( 'click', '#submit', function () {
			...
			$.ajax( {
				url: "<?php echo base_url("lockscreenlogouploaded"); ?>",	// Url to which the request is send
