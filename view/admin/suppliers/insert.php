		...
		<div class="row bg-title">
			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					...
					<li class="active">Supplier Upload</li>
				</ol>
			</div>
			<!-- /.col-lg-12 -->
		</div>
				...
				<div class="white-box">
					<div class=" m-b-20 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
						<div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9">
							<h3 class="box-title m-b-0">New Supplier Upload</h3>
							<span><p class="text-muted m-b-20">Upload Supplier Information:</p></span>
						</div>
						<div class="col-12 col-sm-12 col-md-12 col-lg-3 col-xl-3">
							<a href="<?php echo base_url("supplierlist"); ?>" class="btn btn-block btn-black"><i class="fa fa-list p-r-10"></i> Supplier List</a>
						</div>
					</div>
					<form id="validateForm" action="#" class="form-horizontal" method="POST" enctype="multipart/form-data" autocomplete="off">
						<div class="form-group">
							<div class="ipadform">
								<label class="control-label col-12 col-sm-12 col-md-12 col-lg-1 col-xl-1">Supplier Name:</label>
...
//	MAIN AJAX starts
	$( document ).on( 'click', '#submit', function () {
			...
			$.ajax( {
				url: "<?php echo base_url("supplieruploaded"); ?>",	// Url to which the request is send
